...
const Home = () => {
  ...
  const services = [
  {
    ...
    features: [
      ...
      { icon: "fas fa-window-maximize", text: "Clean and polish all glass frames and tables in the area." }
    ],
    btnText: "Book Now"
  },
  {
    ...
    features: [
      { icon: "fas fa-magic", text: "Maintenance of both resilient and non-resilient flooring." },
      { icon: "fas fa-window-restore", text: "Cleaning of interior and exterior windows." }
    ],
    btnText: "Book Now"
  },
  {
    ...
    features: [
      { icon: "fas fa-th-large", text: "Thorough cleaning of tiles and grout" },
      { icon: "fas fa-couch", text: "Deep cleaning of carpets and upholstery" }
    ],
    btnText: "Book Now"
  }
  ,
  {
    ...
    features: [
      { icon: "fas fa-gem", text: "Marble floor cleaning and polishing" },
      { icon: "fas fa-spray-can", text: "Stripping, waxing, and buffing all types of flooring" }
    ],
    btnText: "Book Now"
  },
  {
